...
public class BlockEntityInit {
    ...
    public static final RegistryObject<BlockEntityType<AcceleratorBlockEntity>> ACCELERATOR_BLOCKENTITY = TILE_ENTITY_TYPES.register("accelerator_1",
            () -> BlockEntityType.Builder.of(AcceleratorBlockEntity::new,
                    BlockInit.ACCELERATOR_1_BLOCK.get(),
                    BlockInit.ACCELERATOR_2_BLOCK.get(),
                    BlockInit.ACCELERATOR_3_BLOCK.get(),
                    BlockInit.ACCELERATOR_4_BLOCK.get()).build(null));
}